...
data = pd.read_csv(r'C:\Users\91916\Desktop\college\4-2\mp\UpdatedResumeDataSet.csv') # Comment this line and uncomment the above line if this does not work for you
data.head()
